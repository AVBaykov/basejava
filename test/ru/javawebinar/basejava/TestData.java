...
public class TestData {
    ...
    static {
        ...
        resume1.setContact(ContactType.EMAIL, "mail1@ya.ru");
        resume1.setContact(ContactType.PHONE, "11111");
        resume1.setSection(SectionType.OBJECTIVE, new TextSection("Objective1"));
        resume1.setSection(SectionType.PERSONAL, new TextSection("Personal data"));
        resume1.setSection(SectionType.ACHIEVEMENT, new ParagraphSection("Achivment11", "Achivment12", "Achivment13"));
        resume1.setSection(SectionType.QUALIFICATIONS, new ParagraphSection("Java", "SQL", "JavaScript"));
